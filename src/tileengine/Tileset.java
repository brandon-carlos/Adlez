...
public class Tileset {
    ...
    public static final TETile WALL = new TETile('z', new Color(216, 128, 128), Color.darkGray,
            "wall", 1);
    ...
    public static final TETile MOUNTAIN = new TETile('▲', Color.lightGray, Color.black, "mountain", 10);
